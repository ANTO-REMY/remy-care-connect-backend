...
class FacilityStaff(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'invitation_email': self.invitation.invitation_email if self.invitation else None,
            'invitation_state': self.invitation.status if self.invitation else None,
            'invitation_expires_at': self.invitation.expires_at.isoformat() if self.invitation and self.invitation.expires_at else None,
